...
<ul>
  ...
  <li><a href="Sede.do" target="content-content"><span>Mantenimiento Sede</span></a></li>
  <li><a href="consultadisponibilidad?opcion=0" target="content-content"><span>Consulta Disponibilidad</span></a></li>
  <li><a href="ConfirmaServicio.jsp" target="content-content"><span>Confirma Servicio </span></a></li>
...
<ul>
  ...
  <li><a href="Sede.do" target="content-content">Mantenimiento de Sedes</a></li>
 <li><a href="consultadisponibilidad?opcion=0" target="content-content"><span>Consulta Disponibilidad</span></a></li>
...
<p class="green"><strong> Recurso del sistema</strong></p>
<p><strong>Adress :</strong> Servicio de Mapas<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dummy
text the 1500s,</p>
...
<div class="footer">
<p>&copy; Diseñado por la UPC <a target="_blank" href="http://www.htmltemplates.net">Templates</a><br /></p>
<ul>
