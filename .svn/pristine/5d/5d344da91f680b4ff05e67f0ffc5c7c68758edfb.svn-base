...
public class ClienteEmpresa {
    ...
    private List<EmpresaSedes> empresaSedes;
    ...
    public List<EmpresaSedes> getEmpresaSedes() {
        return empresaSedes;
    }

    public void setEmpresaSedes(List<EmpresaSedes> empresaSedes) {
    ...
    public ClienteEmpresa() {
        this.clienteEmpleadoses = new ArrayList<ClienteEmpleados>();
         this.empresaSedes = new ArrayList<EmpresaSedes>();
